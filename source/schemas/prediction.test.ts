...
describe("Prediction Schema", () => {
  describe("CompletionSchema", () => {
    ...
    it("should reject non-object completion", async () => {
      ...
      await expect(Effect.runPromise(validateCompletion(invalidCompletion)))
        .rejects.toThrow()
    })
  })
  ...
  describe("CompletionsSchema", () => {
    ...
    it("should reject non-array completions", async () => {
      ...
      await expect(Effect.runPromise(validateCompletions(invalidCompletions)))
        .rejects.toThrow()
    })
  ...
  describe("ReasoningSchema", () => {
    ...
    it("should reject reasoning without text", async () => {
      ...
      await expect(Effect.runPromise(validateReasoning(invalidReasoning)))
        .rejects.toThrow()
    })
  ...
  describe("ConfidenceSchema", () => {
    ...
    it("should reject confidence without score", async () => {
      ...
      await expect(Effect.runPromise(validateConfidence(invalidConfidence)))
        .rejects.toThrow()
    })
  ...
  describe("AggregationMetadataSchema", () => {
    ...
    it("should reject aggregation without method", async () => {
      ...
      await expect(Effect.runPromise(validateAggregationMetadata(invalidAggregation)))
        .rejects.toThrow()
    })
  ...
  describe("PredictionSchema", () => {
    ...
    it("should reject prediction without completions", async () => {
      ...
      await expect(Effect.runPromise(validatePrediction(invalidPrediction)))
        .rejects.toThrow()
    })
  ...
  describe("Factory Functions", () => {
    ...
    it("should reject invalid data in createValidatedPrediction", async () => {
      ...
      await expect(Effect.runPromise(createValidatedPrediction(invalidCompletions)))
        .rejects.toThrow()
    })
  })
