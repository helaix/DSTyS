  ...
  describe("Validation Helpers", () => {
    ...
    describe("validateOrThrow", () => {
      ...
      it("should throw DSPyValidationError for invalid data", () => {
        expect(() => validateOrThrow(StringSchema, 123))
          .toThrow(DSPyValidationError)
      })

      it("should use custom error message", () => {
        expect(() => validateOrThrow(StringSchema, 123, "Custom error"))
    ...
    describe("validateWithCustomError", () => {
      it("should return Right for valid data", () => {
        const result = validateWithCustomError(
          StringSchema,
          "valid string",
          () => "custom error"
        )
  ...
  describe("Integration Tests", () => {
    it("should work with complex validation scenarios", async () => {
      const ComplexSchema = Schema.Struct({
        ...
        preferences: Schema.optional(Schema.Record({
          key: Schema.String,
